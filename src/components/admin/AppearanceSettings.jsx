...
export default function AppearanceSettings() {
  ...
  return (
    <Card className="shadow-lg border-0 col-span-1 lg:col-span-2">
      ...
      <CardContent className="pt-6 space-y-8">
        ...
        <div className="space-y-4">
          <h3 className="font-semibold text-lg">Logo e Título</h3>
        ...
        {/* Seção de Cores */}
        <div className="space-y-4">
          <h3 className="font-semibold text-lg">Paleta de Cores</h3>
        ...
        <div className="space-y-4">
          <h3 className="font-semibold text-lg">Sons de Notificação</h3>
          <div className="space-y-2">
